...
def generate_results_comparison():
    ...
    OAMT_training_time_0_easy = np.load('./Submarine-game-hard/One_agent_multi_training_time0.npy')
    MAOT_training_time_0_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_time0.npy')
    OAMT_training_time_1_easy = np.load('./Submarine-game-hard/One_agent_multi_training_time1.npy')
    MAOT_training_time_1_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_time1.npy')
    OAMT_training_time_2_easy = np.load('./Submarine-game-hard/One_agent_multi_training_time2.npy')
    MAOT_training_time_2_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_time2.npy')
    OAMT_training_time_3_easy = np.load('./Submarine-game-hard/One_agent_multi_training_time3.npy')
    MAOT_training_time_3_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_time3.npy')
    OAMT_training_time_4_easy = np.load('./Submarine-game-hard/One_agent_multi_training_time4.npy')
    MAOT_training_time_4_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_time4.npy')
    ...
    OAMT_training_time_0 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_time0.npy')
    MAOT_training_time_0 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_time0.npy')
    OAMT_training_time_1 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_time1.npy')
    MAOT_training_time_1 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_time1.npy')
    OAMT_training_time_2 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_time2.npy')
    MAOT_training_time_2 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_time2.npy')
    OAMT_training_time_3 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_time3.npy')
    MAOT_training_time_3 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_time3.npy')
    OAMT_training_time_4 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_time4.npy')
    MAOT_training_time_4 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_time4.npy')
    ...
    plt.xlabel('# of environment trained', size=14)
    OAMT_training_forget_0_easy = np.load('./Submarine-game-hard/One_agent_multi_training_forget0.npy')
    MAOT_training_forget_0_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_forget0.npy')
    OAMT_training_forget_1_easy = np.load('./Submarine-game-hard/One_agent_multi_training_forget1.npy')
    MAOT_training_forget_1_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_forget1.npy')
    OAMT_training_forget_2_easy = np.load('./Submarine-game-hard/One_agent_multi_training_forget2.npy')
    MAOT_training_forget_2_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_forget2.npy')
    OAMT_training_forget_3_easy = np.load('./Submarine-game-hard/One_agent_multi_training_forget3.npy')
    MAOT_training_forget_3_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_forget3.npy')
    OAMT_training_forget_4_easy = np.load('./Submarine-game-hard/One_agent_multi_training_forget4.npy')
    MAOT_training_forget_4_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_forget4.npy')
    ...
    OAMT_training_forget_0 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_forget0.npy')
    MAOT_training_forget_0 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_forget0.npy')
    OAMT_training_forget_1 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_forget1.npy')
    MAOT_training_forget_1 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_forget1.npy')
    OAMT_training_forget_2 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_forget2.npy')
    MAOT_training_forget_2 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_forget2.npy')
    OAMT_training_forget_3 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_forget3.npy')
    MAOT_training_forget_3 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_forget3.npy')
    OAMT_training_forget_4 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_forget4.npy')
    MAOT_training_forget_4 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_forget4.npy')
    ...
    plt.xlabel('# of environment trained', size = 14)
    OAMT_training_general_0_easy = np.load('./Submarine-game-hard/One_agent_multi_training_general0.npy')
    MAOT_training_general_0_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_general0.npy')
    OAMT_training_general_1_easy = np.load('./Submarine-game-hard/One_agent_multi_training_general1.npy')
    MAOT_training_general_1_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_general1.npy')
    OAMT_training_general_2_easy = np.load('./Submarine-game-hard/One_agent_multi_training_general2.npy')
    MAOT_training_general_2_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_general2.npy')
    OAMT_training_general_3_easy = np.load('./Submarine-game-hard/One_agent_multi_training_general3.npy')
    MAOT_training_general_3_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_general3.npy')
    OAMT_training_general_4_easy = np.load('./Submarine-game-hard/One_agent_multi_training_general4.npy')
    MAOT_training_general_4_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_general4.npy')
    ...
    OAMT_training_general_0 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_general0.npy')
    MAOT_training_general_0 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_general0.npy')
    OAMT_training_general_1 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_general1.npy')
    MAOT_training_general_1 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_general1.npy')
    OAMT_training_general_2 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_general2.npy')
    MAOT_training_general_2 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_general2.npy')
    OAMT_training_general_3 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_general3.npy')
    MAOT_training_general_3 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_general3.npy')
    OAMT_training_general_4 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_general4.npy')
    MAOT_training_general_4 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_general4.npy')
    ...
    plt.xlabel('# of environment trained', size = 14)
    OAMT_training_access_0_easy = np.load('./Submarine-game-hard/One_agent_multi_training_access0.npy')
    MAOT_training_access_0_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_access0.npy')
    OAMT_training_access_1_easy = np.load('./Submarine-game-hard/One_agent_multi_training_access1.npy')
    MAOT_training_access_1_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_access1.npy')
    OAMT_training_access_2_easy = np.load('./Submarine-game-hard/One_agent_multi_training_access2.npy')
    MAOT_training_access_2_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_access2.npy')
    OAMT_training_access_3_easy = np.load('./Submarine-game-hard/One_agent_multi_training_access3.npy')
    MAOT_training_access_3_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_access3.npy')
    OAMT_training_access_4_easy = np.load('./Submarine-game-hard/One_agent_multi_training_access4.npy')
    MAOT_training_access_4_easy = np.load('./Submarine-game-hard/Multi_agent_one_training_access4.npy')
    ...
    OAMT_training_access_0 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_access0.npy')
    MAOT_training_access_0 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_access0.npy')
    OAMT_training_access_1 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_access1.npy')
    MAOT_training_access_1 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_access1.npy')
    OAMT_training_access_2 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_access2.npy')
    MAOT_training_access_2 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_access2.npy')
    OAMT_training_access_3 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_access3.npy')
    MAOT_training_access_3 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_access3.npy')
    OAMT_training_access_4 = np.load('./Submarine-game-hard-PPO/One_agent_multi_training_access4.npy')
    MAOT_training_access_4 = np.load('./Submarine-game-hard-PPO/Multi_agent_one_training_access4.npy')
