...
def generate_models():
   ...
   for i in range(50000,50030):
      ...
      np.save('../../../experiments/Coinrun/Training_upgraded/upgraded_training_gen_'+str(coef)+'_'+str(i)+'.npy',gen_upgraded)
      ...
      for k in range(0,20):
         print("Cycle: ",k)
         ag.change_environment(i)
         baseline_steps = ag.solve_cycle(50000)
      ...
      np.save('../../../experiments/Coinrun/Training_upgraded/baselines_training_gen_'+str(i)+'.npy',gen_baselines)
