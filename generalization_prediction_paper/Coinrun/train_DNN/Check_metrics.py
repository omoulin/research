...
def generate_metrics():
	...
	for cpt in ra:
		y_val[i] = np.load('../../../experiments/Coinrun/generalization/Average_reward'+str(cpt)+'.npy')
		print("Environment: ",i)
		print("Loading weights.")
		weights_EXT_1=np.load('../../../experiments/Coinrun/weights/Weights_EXT_1_'+str(cpt)+'.npy').flatten()
		weights_EXT_2=np.load('../../../experiments/Coinrun/weights/Weights_EXT_2_'+str(cpt)+'.npy').flatten()
		weights_ACT=np.load('../../../experiments/Coinrun/weights/Weights_ACT_'+str(cpt)+'.npy').flatten()
	...
	plt.savefig('../../../experiments/Coinrun/analysis/percentile25-layer1.pdf')
	plt.clf()
	...
	plt.savefig('../../../experiments/Coinrun/analysis/percentile50-layer1.pdf')
	plt.clf()
	...
	plt.savefig('../../../experiments/Coinrun/analysis/percentile75-layer1.pdf')
	plt.clf()
	...
	plt.savefig('../../../experiments/Coinrun/analysis/percentile100-layer1.pdf')
	plt.clf()
	...
	plt.scatter(x_indices,correlation_score,s=3)
...
#		plt.text(x_indices[i], correlation_score[i], label, fontsize=12, ha='right')
	...
	plt.savefig('../../../experiments/Coinrun/analysis/pearson_correlation.pdf')
	plt.clf()
